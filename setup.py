...
setup(
    ...
    extras_require={"dev": ["autoflake==1.*,>=1.3.1", "black==21.7b0", "codecov==2.*,>=2.1.12", "dephell==0.*,>=0.8.2", "flake8==4.*,>=4.0.1", "isort==5.*,>=5.10.1", "mistune<2.0.0", "mypy==0.*,>=0.920.0", "pyproject-flake8==0.*,>=0.0.1.a2", "pytest==6.*,>=6.2.5", "pytest-asyncio==0.*,>=0.16.0", "pytest-cov==3.*,>=3.0.0", "tomlkit==0.7.0"]},
)
